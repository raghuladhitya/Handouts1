...
public class SignupAdminActivity extends AppCompatActivity {
    ...
    public void addDetails(String name, String pass, String admin) {
        ...
        if (isInternetConnection()) {
            if (phone.length() == 10) {
                if (dept.length() != 0) {
                    if (isValidEmail(email)) {
                        ...
                        Dialog.show();
                        Intent intent = new Intent(SignupAdminActivity.this, PhoneActivity.class);
            ...
            Toast toast = Toast.makeText(SignupAdminActivity.this, "Please check your internet connction", Toast.LENGTH_LONG);
            toast.show();
        }
    }
